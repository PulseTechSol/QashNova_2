  ...
  return <Box sx={{ bgcolor: "#fff",}}>
    ...
    >
      ...
      <Typography sx={{
       ...
       <Typography sx={{width:"100%",fontSize:"18px" ,color:"#00000080", textAlign:"center", fontWeight:"400",maxWidth:{md:"800px",lg:"864px"}}}>
       Crafting bespoke websites in Rotherham, South Yorkshire, and Sheffield, we blend stunning aesthetics with powerful functionality. Our designs are tailored to elevate your brand.
       </Typography>
{/* </Box> */}
    </Box>
